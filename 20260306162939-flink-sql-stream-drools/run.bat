...
java --add-opens=java.base/java.util=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/java.util.concurrent=ALL-UNNAMED -jar target\flink-transaction-tagging-1.0.0.jar sql %INPUT_FILE% %OUTPUT_FILE%
goto end
